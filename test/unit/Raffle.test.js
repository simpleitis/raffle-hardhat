...
!developmentChains.includes(network.name)
    ...
    : describe("Raffle Unit Tests", function () {
          ...
          describe("checkUpkeep", function () {
              it("returns fale if people haven't send any ETH", async function () {
                  await network.provider.send("evm_increaseTime", [interval.toNumber() + 1])
                  await network.provider.send("evm_mine", [])

                  //'callStatic' is used to call the 'checkUpkeep' function without sending out a transaction but simulates sending the transaction and getting the return value
          ...
          describe("performUpKeep", function () {
              ...
              it("updates the raffle state, emits an event and calls the vrf coordinator", async function () {
                  ...
                  // we are accessing the event emitted by the 'vrf coordinator' here so we dont have to check if the 'vrfcoordinator' is called
                  ...
                  await new Promise(async (resolve, reject) => {
                      raffle.once("WinnerPicked", async () => {
                          ...
                          try {
                              ...
                              console.log("Raffle winner:", recentWinner)
                              ...
                              assert.equal(
                                  ...
                                  // below is boilerplate code for calculating the total money, including the gas fees which was transfered
                      ...
                      // when unit testing we know the account at index 1 is going to win everytime as we have already checked this by printing out all the accounts and the account winner
